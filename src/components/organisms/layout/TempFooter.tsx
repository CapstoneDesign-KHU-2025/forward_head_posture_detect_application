  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-end px-6 py-3 bg-[var(--green-pale)]">
      <Link
        ...
        className="px-6 py-3 text-[17px] font-bold text-[var(--danger-text)] bg-[var(--danger-bg)] hover:text-[var(--danger-dark)] hover:bg-[#ffe5e0] rounded-[12px] transition-colors border-2 border-[var(--danger-text)]"
      >
        {t("feedback")}
      </Link>
    </footer>
